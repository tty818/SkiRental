    ...
    <div style="padding: 10px; background-color: #F2F2F2;">
        <div class="layui-row layui-col-space10">
            <div class="layui-col-md4">
                <div class="layui-skid">
                    <div class="layui-skid-header">雪具信息</div>
                    <div class="layui-skid-body" id="ski_skinumber"></div>
                    <div class="layui-skid-body" id="ski_skitype"></div>
                    <div class="layui-skid-body" id="ski_color"></div>
                    <div class="layui-skid-body" id="ski_price"></div>
                    <div class="layui-skid-body" id="ski_rentprice"></div>
                    <div class="layui-skid-body" id="ski_deposit"></div>
                    <div class="layui-skid-body" id="ski_description"></div>
                    <div class="layui-skid-body">
                        雪具图片：<img src="" width="200" height="150" id="ski_skiimg">
                    </div>
                </div>
            </div>
            <div class="layui-col-md4">
                <div class="layui-skid">
                    <div class="layui-skid-header">出租单信息</div>
                    <div class="layui-skid-body" id="rent_rentid"></div>
                    <div class="layui-skid-body" id="rent_price"></div>
                    <div class="layui-skid-body" id="rent_begindate"></div>
                    <div class="layui-skid-body" id="rent_returndate"></div>
                    <div class="layui-skid-body" id="rent_opername"></div>
                </div>
            </div>
            <div class="layui-col-md4">
                <div class="layui-skid">
                    <div class="layui-skid-header">客户信息</div>
                    <div class="layui-skid-body" id="customer_identity"></div>
                    <div class="layui-skid-body" id="customer_custname"></div>
                    <div class="layui-skid-body" id="customer_sex"></div>
                    <div class="layui-skid-body" id="customer_address"></div>
                    <div class="layui-skid-body" id="customer_phone"></div>
                    <div class="layui-skid-body" id="customer_skieer"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${alfred}/check/checkRentExist.action", {rentid: rentid}, function (obj) {
                if (obj === "") { //出租单号不存在，返回值为null
                    ...
                    if (obj.rentflag == 1) {
                        layer.msg("您输入的出租单号相关雪具已经归还，无需再入库");
                        $("#content").hide();
                    } else {
                        //初始化表单数据和卡片面板数据
        ...
        function initCheckFormData(rentid) {
            $.post("${alfred}/check/initCheckFormData.action",{rentid:rentid},function (obj) {
                ...
                $("#customer_skieer").html("客户职位: "+customer.skieer);
                ...
                //雪具信息
                var ski=obj.ski;
                $("#ski_skinumber").html("雪具号牌: "+ski.skinumber);
                $("#ski_skitype").html("雪具类型: "+ski.skitype);
                $("#ski_color").html("雪具颜色: "+ski.color);
                $("#ski_price").html("购买价格: "+ski.price);
                $("#ski_rentprice").html("出租价格: "+ski.rentprice);
                $("#ski_deposit").html("出租押金: "+ski.deposit);
                $("#ski_description").html("雪具描述: "+ski.description);
                $("#ski_skiimg").attr("src","${alfred}/file/downloadShowFile.action?path="+ski.skiimg);
            })
        }
        //保存
