    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="returndate" id="returndate" readonly="readonly" lay-verify="required" placeholder="请输入还雪具时间" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , cols: [[   //列表数据
                ...
                , {field: 'skinumber', title: '雪具号', align: 'center', width: '105'}
                ...
                , {field: 'returndate', title: '还雪具时间', align: 'center', width: '170'}
