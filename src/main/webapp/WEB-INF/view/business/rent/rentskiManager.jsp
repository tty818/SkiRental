...
<div id="content" style="display: none;">
    <table id="skiTable" lay-filter="skiTable"></table>
    <div id="skiBar" style="display: none;">
        <a class="layui-btn layui-btn-warm layui-btn-xs layui-btn-radius" lay-event="rentski">出租雪具</a>
        <a class="layui-btn layui-btn-xs layui-btn-radius" lay-event="viewImage">查看雪具大图</a>
    </div>
</div>
...
<div style="display: none;padding: 20px;" id="saveOrUpdateDiv">
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">还雪具时间:</label>
                <div class="layui-input-inline">
                    <input type="text" name="returndate" id="returndate" lay-verify="required" placeholder="请输入还雪具时间" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="skinumber" lay-verify="required" readonly="readonly"  placeholder="请输入雪具号" class="layui-input">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        function initskiData() {
            //渲染数据表格
            tableIns = table.render({
                elem: '#skiTable'   //渲染的目标对象
                , url: '${alfred}/ski/loadAllski.action?isrenting=0' //数据接口
                , title: '雪具列表'//数据导出来的标题
                , height: 'full-150'
                , page: true  //是否启用分页
                , cols: [[   //列表数据
                    , {field: 'skinumber', title: '雪具号', align: 'center', width: '95'}
                    , {field: 'skitype', title: '出租类型', align: 'center', width: '90'}
                    ...
                    , {fixed: 'right', title: '操作', toolbar: '#skiBar', align: 'center', width: '220'}
                ]]
            });
        ...
        function openRentski(data) {
            mainIndex = layer.open({
                ...
                success: function (index) {
                    //清空表单数据
                    $("#dataFrm")[0].reset();
                    //请求数据,分别拿到出租价格，身份证号，雪具号
                    var price=data.rentprice;
                    var identity=$("#identity").val();
                    var skinumber=data.skinumber;
